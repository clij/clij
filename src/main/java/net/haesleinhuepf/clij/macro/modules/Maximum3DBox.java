 ...
 * 12 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_maximum3DBox")
public class Maximum3DBox extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
