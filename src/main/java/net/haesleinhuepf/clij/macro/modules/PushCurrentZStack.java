...
@Deprecated
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_pushCurrentZStack")
public class PushCurrentZStack extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
