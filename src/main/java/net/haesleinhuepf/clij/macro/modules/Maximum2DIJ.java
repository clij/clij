 ...
 * December 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_maximum2DIJ")
public class Maximum2DIJ extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, CLIJImageJProcessor, OffersDocumentation {
    ...
    public boolean executeCL() {
        ...
        if (containsCLImageArguments()) {
            return Kernels.maximumIJ(clij, (ClearCLImage)( args[0]), (ClearCLImage)(args[1]), radiusX);
        } else {
            Object[] args = openCLBufferArgs();
            boolean result = Kernels.maximumIJ(clij, (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), radiusX);
            releaseBuffers(args);
            return result;
        }
    }
    ...
    public boolean executeIJ() {
        ...
        IJ.run(input, "Maximum...", "radius=" + radius);
