...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_multiplyPixelwise")
public class MultiplyPixelwise extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
