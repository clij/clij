 ...
 * December 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_detectMinima")
public class DetectMinima extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
