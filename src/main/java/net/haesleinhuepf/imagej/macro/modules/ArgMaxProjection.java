 ...
 * December 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_argMaxProjection")
public class ArgMaxProjection extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
