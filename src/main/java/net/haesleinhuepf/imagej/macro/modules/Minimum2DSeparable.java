 ...
 * 12 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_minimum2dSeparable")
public class Minimum2DSeparable extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
