...
public class Mask extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
    ...
    public boolean executeCL() {
        if (containsCLImageArguments()) {
            return Kernels.mask(clij, (ClearCLImage)( args[0]), (ClearCLImage)(args[1]), (ClearCLImage)(args[2]));
        } else {
            Object[] args = openCLBufferArgs();
            boolean result = Kernels.mask(clij, (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), (ClearCLBuffer)(args[2]));
            releaseBuffers(args);
            return result;
        }
    }
