...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_minPixelwise")
public class MinPixelwise extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
