...
public class MaximumSliceBySlice extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
    ...
    public boolean executeCL() {
        ...
        if (containsCLImageArguments()) {
            return Kernels.maximumSliceBySlice(clij, (ClearCLImage)( args[0]), (ClearCLImage)(args[1]), radiusX, radiusY);
        } else {
            Object[] args = openCLBufferArgs();
            boolean result = Kernels.maximumSliceBySlice(clij, (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), radiusX, radiusY);
            releaseBuffers(args);
            return result;
        }
    }
