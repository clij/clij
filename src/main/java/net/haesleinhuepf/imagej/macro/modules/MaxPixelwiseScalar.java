...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_maxPixelwiseScalar")
public class MaxPixelwiseScalar extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
