 ...
 * December 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_addWeightedPixelwise")
public class AddWeightedPixelwise extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
