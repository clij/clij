 ...
 * 12 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_maximum3dSeparable")
public class Maximum3DSeparable extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
