...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_dividePixelwise")
public class DividePixelwise extends AbstractCLIJPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor {
