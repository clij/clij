...
public class Kernels
{
    ...
    public static boolean blurSeparable(ClearCLIJ clij, ClearCLImage src, ClearCLImage dst, float... blurSigma) {
        ...
        boolean result = blurSeparable(clij, src, dst, temp, blurSigma);
        clij.release(temp);

        return result;
    }

    public static boolean blurSeparable(ClearCLIJ clij, ClearCLImage src, ClearCLImage dst, ClearCLImage temp, float... blurSigma) {
...
//      System.out.println("n[" + d + "] = " + n[d]);
    ...
    public static boolean tenengradFusion(ClearCLIJ clij, ClearCLImage clImageOut, float[] blurSigmas, ClearCLImage... clImagesIn) {
        ...
        ClearCLImage temporaryImage2 = clij.createCLImage(clImagesIn[0]);
        ...
        for (int i = 0; i < clImagesIn.length; i++) {
            ...
            blurSeparable(clij, temporaryImage, temporaryImages[i], temporaryImage2, blurSigmas[0], blurSigmas[1], blurSigmas[2]);
